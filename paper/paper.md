...
| `graphbin2` | Bin refinement tool GraphBin2                              | Contigs, assembly graph file(s)[^1], initial binning result, coverage of contigs                  |
| `metacoag`  | Binning tool MetaCoAG                                      | Contigs, assembly graph file(s)[^1], coverage of contigs                                          |
...
[^1]: The assembly graph files can vary depending on the assembler used to generate the contigs.
